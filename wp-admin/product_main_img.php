<?php
 ...
 $product_id    = $main_id;
    if ($product_id) {
      ...
      if (isset($_FILES['product_main_img']) && $_FILES['product_main_img']['error'] === UPLOAD_ERR_OK) {
        $file_tmp = $_FILES['product_main_img']['tmp_name'];
        $file_name = $_FILES['product_main_img']['name'];
        $file_size = $_FILES['product_main_img']['size'];
        $file_type = $_FILES['product_main_img']['type'];
